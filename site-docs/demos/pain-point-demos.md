...
| [`07-cross-agent-handoff`](https://github.com/m24927605/ait/tree/main/examples/pain-point-demos/07-cross-agent-handoff) | Cross-agent handoff | An accepted Claude decision becomes repo memory that Codex can consume later. |
